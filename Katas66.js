...
describe('An object literal can also contain getters', () => {
    it('just prefix the property with `get` (and make it a function)', function() {
      const obj = {
        //x() { return 'ax'; }
        get x() { return 'ax'; }
        //added get to the function so now it contains getters
      };
    ...
    it('must have NO parameters', function() {
      const obj = {
        //x(param) { return 'ax'; }
       get x() { return 'ax'; }
       //turned in into a get with no params by removing params from the function
    ...
    it('can be removed using delete', function() {
      ...
      //delete obj.y;
      delete obj.x;
      //delete obj.y needed to be delete obj.x
