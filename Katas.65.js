...
describe('`Set` API overview', function(){
    ...
    it('`entries()` returns an iterator for all values', function() {
      ...
      //changed set.entry to set.entries
