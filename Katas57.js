...
describe('Default parameters make function parameters more flexible', () => {
    ...
    it('it is used when `undefined` is passed', function() {
      ...
      // showed when undefined is passed in the const param
