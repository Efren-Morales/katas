...
describe('Object literal properties may be computed values', () => {
    it('a computed property `x` needs to be surrounded by `[]`', () => {
      ...
      // added brackets to propertyName which is the computed properties 'x'
    ...
    it('can also get a function assigned', () => {
      ...
      // made 'key' a function with () after and put 'seven' in {} with a return 
      // named
    ...
    it('the key may also be the result of a function call', () => {
      ...
      //made getName a function with ()after it in []
    ...
    it('the key can also be constructed by an expression', () => {
      ...
      // changed 'key' to 'Name' and 'proper' to 'property'
